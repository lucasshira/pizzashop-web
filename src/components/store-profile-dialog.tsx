...
const StoreProfileDialog = () => {
  ...
  const { data: managedRestaurant } = useQuery({
    // mesma queryKey usada no AccountMenu, para pegar os dados do restaurante que ja estao no cache
  ...
  function updateManagedRestaurantCache({
    ...
    if (cached) {
      // setar uma nova query com os dados atualizados
